...
- 웹 데이터 서칭 및 분석: 웹 사이트를 탐색하고 분석하여 새로운 창작물로 전환.

- 데이터 분석 보조: Excel, txt, pdf, png 등 데이터 처리 및 차트 생성 지원.

- 창의적 디자인 지원: AI 기반으로 디자인 제안 및 템플릿 생성.

- 문제 해결 제안: 코드 디버깅 및 오류 수정 지원.

- MS System Helper: Microsoft 전체 시스템에 대한 설명 및 세부 작업 팁 도우미.

## 2. Copilot의 종류와 특징

개정 중심 분류: Microsoft 개인 계정 버젼과 조직 계정 버젼, Microsoft 365계정에 Copilot pro를 연동한 버젼으로 구분

환경 중심 분류: Microsoft Web Copilot, Ms store 설치형, Copliot, Edge연동 Copliot, GitHub Copilot
...
- 일반 코파일럿: 개인 개정을 사용하여 로그인 할 수 있는 코파일럿입니다.

- M365 Chat 코파일럿: Microsoft 365 아이디를 사용하여 로그인할 수 있는 코파일럿입니다.

2) Edge 연동 Copilot: Microsoft Edge 브라우저와 연동하여 Copilot 기능을 브라우저에서 바로 활용할 수 있습니다. 웹 화면 데이터를 읽고, 분석하고, 질문하고, 재생산하는데 유용합니다. 엣지 오른쪽 사이드 상단에 위치하여 필요할 때 클릭하여 사용할 수 있습니다.

3) Web용 Microsoft Copilot: Office 365에서 생산성을 향상시키기 위한 기능으로, Word, Excel, Teams 등에 통합되어 사용되기 한 지속적인 업데이트가 되고 있습니다. 설치형 Copilot과 인터페이스가 똑같습니다.

4) GitHub Copilot: 개발자를 위한 코드 자동 완성 도구로, 다양한 프로그래밍 언어를 지원합니다. 2024년 12월 말 부터 Github Copilot은 누구에게나 무료화 되었습니다.다만, 채팅 응답은 매월 2,000개의 코드 완성과 50개의 채팅 메시지로 제한됩니다. GitHub Education을 A3계정과 연동하여 받으시면 GitHub Copilot Pro와 상응하는 벼전을 사용할 수 있습니다. 관련 내용은 [GitHub Copilot · Your AI pair programmer · GitHub](https:/github.com/features/copilot)에서 확인하세요. 본 Copliot 교안에서는 GitHub Copilot은 이정도까지만 소개합니다.

## 3. Copilot 사용 요구사항

- 운영 체제: Windows 11 이상(Window 10 은 2024년 10월에 지원 종료), MacOS 11 이상

- 브라우저: Microsoft Edge 최신 버전 권장(Mac os 및 Chrome도 가능)
...
1) Copilot: 개인용 코파일럿으로 개인 아이디를 로그인하여 접속해야 합니다.

2) M365 Coiplit Chat(이하 M365 Copilot): 학교 아이디로 로그인 하여 접속해야 합니다.

설치가 완료 되면 [열기]를 클릭하여 실행합니다.
...
1) 파일을 업로드 하고 스크린샷을 촬영하여 도움을 받을 수 있습니다.

2) Think Deeper 기능을 활용하여 더 정확하고 깊이 있는 분석을 이끌어 낼 수 있습니다.
...
오늘 뉴스, 지식 관련 주제 대화, 일상 회화 연습 등 다양하게 활용할 수 있습니다.

개인용 코파일럿은 학생을 대상으로 설계된 코파일럿은 아닙니다. 따라서 가장 보편적으로 사용할 수 있는 기능만 탑재해 두었으며, 관련 방향으로 지속적인 업데이트를 하고 있습니다.
...
1) 콘텐츠를 추가할 수 있습니다. 다음 디바이스에서 추가도 가능하지만, Microsoft 365 아이디와 연결된 Onedrive에서도 추가가 가능합니다. 파일 종류는 .pdf , .ppt , .xlsx 등 다양하게 업로드 할 수 있습니다.

2) Microsoft에서 제공하는 Copilot 기본 에이젼트를 사용할 수 있습니다. 학교 현장에 사용할만한 에이젼트는 '수학 도우미' 입니다. 수학 개념에 대해 자세하고 쉽게 설명해줍니다.

3) 에이젼트를 만들어서 사용할 수 있습니다. '학교 상황에 맞는 에이젼트를' 제작하여 활용 가능합니다.
...
- Microsoft 365 Copilot과 Copilot Chat에서 사용되는 데이터 보호 조치와 약속을 의미합니다.

- 데이터 보호 추가 약정(DPA)과 제품 약관에 따라 고객 데이터가 보호됩니다.

2)프롬프트와 응답 보호사용자 입력(프롬프트)과 Copilot이 생성한 콘텐츠(응답)는 Microsoft 365의 상업적 제공과 동일한 계약 조건으로 보호됩니다.데이터는 저장 및 전송 시 암호화되고, 물리적 보안 조치와 테넌트 간 데이터 격리가 이루어집니다.

3)웹 검색 쿼리의 프라이버시와 보안Bing 검색 서비스를 통해 웹 콘텐츠를 참조하여 최신 정보를 제공합니다.웹 검색 쿼리는 안전한 연결을 통해 전송되며, 광고주와 공유되지 않고, 대규모 언어 모델(LLM) 훈련에 사용되지 않습니다.

위 규약과 정책에 근거하여 교사와 학생들이 코파일럿과 대화나는 개인 정보 데이터를 '광고' 등으로 사용하지 않으며, 훈련에도 사용하지 않는 등 철저하게 보호하는 조치를 취하고 있습니다.
...
🍀Copliot의 업데이트 속도는 엄청나게 빠릅니다. Microsoft 365 와 연동되는 Copliot의 최신 업데이트 소식을 확인하세요. 아래는 2025년 05월 11일에 업데이트 된 릴리즈 도큐먼트입니다. Copilot을 친구처럼 사용하고 싶으시다면 아내 내용을 수시로 확인하는 것을 추천합니다.

[IT 역량을 강화하기 위한 Microsoft Copilot 작업, 새로운 에이전트 및 도구 소개| Microsoft 365 블로그](https:/www.microsoft.com/en-us/microsoft-365/blog/2024/11/19/introducing-copilot-actions-new-agents-and-tools-to-empower-it-teams)